...
ollama_ui attaches local-model chat/status UI, kaggle_cabt attaches the Pokémon TCG
CABT workload UI/API, and web attaches the main dashboard. Run this module with uvicorn.
"""
from app import app
